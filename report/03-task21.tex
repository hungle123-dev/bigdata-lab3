...
\quad Sort node & 1 & 7 \\
(c) Số stage (đo bằng SparkListener) & 10 & --- \\
\hline
\end{tabular}
\end{center}
...
\textbf{(c)} Đo bằng \texttt{SparkListener.onStageCompleted} quanh action \texttt{write}: \textbf{10 stage} (AQE tắt, broadcast bật). Với AQE bật, số stage thực tế thay đổi do coalesce động — đọc trực tiếp ở Spark UI tab Jobs (\texttt{localhost:4040}).
